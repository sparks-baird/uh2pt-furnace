...
Welcome to `uh2pt-furnace` contributor's guide.
...
If you experience bugs or general issues with `uh2pt-furnace`, please have a look
...
You can help improve `uh2pt-furnace` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`uh2pt-furnace` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `uh2pt-furnace`'s files. While this mechanism can
...
```
conda create -n uh2pt-furnace python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/uh2pt-furnace.git
   cd uh2pt-furnace
   ```
...
5. Install [pre-commit]:
   ...
   `uh2pt-furnace` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/uh2pt-furnace
[issue tracker]: https://github.com/<USERNAME>/uh2pt-furnace/issues
